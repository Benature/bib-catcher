...
c = (
    ...
    .add("", nodes, links, categories, repulsion=1000,
         ...
         is_selected=True, is_draggable=True)
    .set_global_opts(title_opts=opts.TitleOpts(title="References"))
)
c.render_notebook()
c.render('index.html')
